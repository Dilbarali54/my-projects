...
const Contact = () => {
  return (
    <div>
    <div className="shadow-lg p-40 m-40 items-center  py-6">
      <h2 className=' px-4 text-center text-5xl text-white py-11 font-serif'><span>Contact</span></h2>
      <form>
        ...
        <div className="mb-4">
          <label className="block text-2xl font-bold"><span>Email: </span></label>
          <input
            type="email"
            name="email"
        ...
        <div className="mb-4">
          <label className="block text-2xl font-bold"><span>Message:</span></label>
          <textarea
            name="message"
